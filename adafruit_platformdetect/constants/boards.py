...
# Loongson Pi Boards
LOONGSON_PI_2K_EDU = "LOONGSON_PI_2K_EDU"
LOONGSON_PI_2K_GENERIC = "LOONGSON_PI_2K_GENERIC"
...
# Loongson Pi
_LOONGSON_PI_BOARD_IDS = {
    LOONGSON_PI_2K_EDU: ("Loongson-2K-SOC-1w-V1.1-EDU_UDB",),
    LOONGSON_PI_2K_GENERIC: ()
}
